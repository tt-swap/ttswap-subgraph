...
Thanks for your interest in contributing to TTSWAP, The contracts in this repo are develop - we are releasing the draft code  with open feedback and meaningful community contribution. We expect this will be a months-long process, and we appreciate any kind of contribution, no matter how small.
...
All pull requests should be opened against the `master` branch. In the pull request, please reference the issue you are fixing.
